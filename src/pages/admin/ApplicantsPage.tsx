          ...
          <div className="flex items-start gap-4">
            <div className="w-16 h-16 rounded-full overflow-hidden bg-muted flex-shrink-0">
              {applicant.personal_photo ? (
                <img src={applicant.personal_photo} alt={applicant.full_name} className="w-full h-full object-cover" />
              ) : (
            ...
            {type === 'drivers' ? (
              <>
                <div className="flex justify-between text-sm py-1 border-b border-dashed">
                  ...
                  <span className="font-medium">{applicant.license_number}</span>
                </div>
                <div className="mt-2">
                  ...
                  <div className="w-full h-24 rounded-lg bg-muted overflow-hidden">
                    {applicant.license_photo ? (
                      <img src={applicant.license_photo} alt="License" className="w-full h-full object-cover" />
                    ) : (
                  ...
                  <div>
                    ...
                    <div className="h-16 rounded bg-muted overflow-hidden">
                      {applicant.id_card_photo_front ? (
                        <img src={applicant.id_card_photo_front} alt="ID Front" className="w-full h-full object-cover" />
                      ) : (
                        <div className="w-full h-full flex items-center justify-center text-muted-foreground">
                  ...
                  <div>
                    ...
                    <div className="h-16 rounded bg-muted overflow-hidden">
                      {applicant.id_card_photo_back ? (
                        <img src={applicant.id_card_photo_back} alt="ID Back" className="w-full h-full object-cover" />
                      ) : (
                        <div className="w-full h-full flex items-center justify-center text-muted-foreground">
                          <ImageIcon className="w-4 h-4" />
                        </div>
